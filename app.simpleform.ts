  ...
  <div class="jumbotron">
    ...
    <form #form="ngForm" (ngSubmit)="submitForm(form.value)">
     <div class="form-group">
        ...
        <input type="text" class="form-control" placeholder="Rajesh" name="firstName" ngModel required>
      </div>
      <div class="form-group">
        <label>Last Name</label>
        <input type="text" class="form-control" placeholder="Kumar" name="lastName" ngModel required>
      </div>
      <div class="form-group">
        <label>Gender</label>
      </div>
